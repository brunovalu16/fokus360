...
import capatarefas from "../../../src/assets/images/capatarefas.webp"
    ...
    <>
      ...
      >
        <Box display="flex" alignItems="center" gap={1}>
          <PlayCircleFilledIcon sx={{ color: "#34d399", fontSize: 25 }} />
          <Typography color="#858585">FOKUS 360 | TAREFAS</Typography>
        </Box>
