...
import StatusProgresso3 from "./StatusProgresso3";
import {
...
const SelectAreaStatus4 = ({ estrategica, areas, value, onChangeArea }) => {
      ...
      {value && (
        <>
          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            ...
            <StatusProgresso3 progresso={progressoTatica} tipo="tatica" />
          </Box>
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            ...
            <StatusProgresso3 progresso={progressoOperacional} tipo="operacional" />
          </Box>
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            ...
            <StatusProgresso3 progresso={progressoTarefa} tipo="tarefa" />
          </Box>
...
export default SelectAreaStatus4;
